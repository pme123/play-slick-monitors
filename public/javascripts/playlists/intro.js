...
define(function (require, exports, module) {
    ...
    module.exports =
    {
        photoFontSize: parseInt(slideWidth/15)+"pt",
        perspective: 1000,
        ...
        lightboxFadeIn: {duration: 1500, curve: 'easeIn'},
        lightboxShakeRotate: {duration: 200, curve: 'easeOut'},
        lightboxBounceRotate: {method: 'spring', period: 600, dampingRatio: 0.15}
    };
});
